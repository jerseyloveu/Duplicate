...
import { faMapMarkerAlt, faPhone, faEnvelope, faClock, faExclamationCircle, faTimes, faCheck } from '@fortawesome/free-solid-svg-icons';
...
// Custom styles for react-select with smaller text and height
const customSelectStyles = {
  ...
  function Register() {
    ...
    // Format phone number to Philippine format (09XX-XXX-XXXX)
    ...
    const validateForm = () => {
      ...
      const phoneRegex = /^09\d{2}-\d{3}-\d{4}$/; // Philippine mobile format
              ...
              <div className="juan-registration-form">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="juan-form-grid">
                    ...
                    {/* Date of Birth - with max date restriction */}
                    <div className="juan-form-group">
                      <label htmlFor="dob">
                    ...
                    <div className="juan-form-group">
                      ...
                      />
                      {errors.email && <span className="juan-error-message">{errors.email}</span>}
                    </div>
  
                    {/* Mobile with Philippine format */}
                    <div className="juan-form-group">
